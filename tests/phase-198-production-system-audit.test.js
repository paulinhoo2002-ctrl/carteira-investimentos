...
test('fase 198 ativa e sequencia planejada registrada', () => {
  ...
  assert.match(roadmap, /- Fase 198 aberta para auditoria geral do sistema em producao;/);
  assert.match(phase198, /Objetivo:/);
  assert.match(phase198, /auditar funcionamento, dados, seguranca, interface, acessibilidade, performance e manutencao/i);
