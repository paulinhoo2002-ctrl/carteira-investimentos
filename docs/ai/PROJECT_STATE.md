...
- PR #414 remains a separate OPEN governance PR; its branch has been reconciled with the current `origin/main` by a normal merge. Check its live head, CI and deployment before making release/readiness claims. No PR merge was performed.
