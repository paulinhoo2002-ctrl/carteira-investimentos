...
## Controlled Merge and Production Smoke

- `PR_NUMBER=352`
- `PR_HEAD=14a21de8d156f4e08e428c2449c307976a1d49d9`
- `MERGE_STATUS=PASS`
- `MERGE_COMMIT_SHA=07e9d558f2588889b328eb625efd7343412fbcb2`
- `ORIGIN_MAIN_AFTER_MERGE=07e9d558f2588889b328eb625efd7343412fbcb2`
- `MERGE_TO_MAIN_TRIGGERS_PRODUCTION_DEPLOY=true`
- `PREVIOUS_PRODUCTION_COMMIT=d3170e9fda8f9a1b9b9746cc950ceb5445c3d3c2`
- `PREVIOUS_PRODUCTION_DEPLOYMENT=6268847043`
- `ROLLBACK_METHOD=Vercel rollback to deployment 6268847043 or controlled revert of merge commit`
- `ROLLBACK_READY=true`
- `VERCEL_PRODUCTION_STATUS=success`
- `VERCEL_PRODUCTION_COMMIT=07e9d558f2588889b328eb625efd7343412fbcb2`
- `PRODUCTION_URL=https://carteira-investimentos-delta.vercel.app`
- `PRODUCTION_LOGIN=NOT_TESTED; expected access-restricted Google login was shown and no authorized browser session was available.`
- `TESTMODE_CANNOT_BYPASS_PRODUCTION_AUTH=true`
- `PRODUCTION_PRIMARY_ROUTES=NOT_TESTED; protected by the expected application auth gate.`
- `MARKET_PRODUCTION_SMOKE=NOT_TESTED; authenticated access unavailable.`
- `REPORT_PDF_PRODUCTION_SMOKE=NOT_TESTED; authenticated access unavailable.`
- `IRPF_PDF_PRODUCTION_SMOKE=NOT_TESTED; authenticated access unavailable.`
- `FIREBASE_READ_SMOKE=NOT_TESTED; no authorized session was used.`
- `FIREBASE_WRITE_SMOKE=NOT_TESTED`
- `SECURITY_PRODUCTION_SMOKE=NOT_TESTED; no credentials, PIN or recovery state was changed.`
- `SECURITY_WRITE_SMOKE=NOT_TESTED`
- `PWA_PRODUCTION_SMOKE=PASS_WITH_LIMITATION; manifest and service worker registration were available, but authenticated update behavior was not exercised.`
- `BROWSER_390=PASS_WITH_LIMITATION; public auth shell, HTTP 200, overflow 0, page errors 0.`
- `BROWSER_1366=PASS_WITH_LIMITATION; public auth shell, HTTP 200, overflow 0, page errors 0.`
- `DOCUMENT_OVERFLOW=0`
- `FINANCIAL_CLIPPING=NOT_OBSERVABLE_BEHIND_AUTH_GATE`
- `PAGE_ERRORS=0`
- `REAL_DATA_INTEGRITY=NOT_TESTED; no real data was accessed or changed.`
- `ROLLBACK_TRIGGERED=false`
- `ROLLBACK_RESULT=NOT_EXECUTED`
- `REMAINING_EXTERNAL_LIMITATIONS=Authenticated market/PDF/Firebase/security flows and authenticated PWA update behavior remain untested because no authorized session was available.`
- `PRODUCTION_RELEASE_STATUS=PASS_WITH_LIMITATIONS`
- `SAFE_TO_REMOVE_WORKTREE=false`

## Release Closure

- `RELEASE_TECHNICALLY_CLOSED=true`
- `PR_NUMBER=352`
- `MERGE_COMMIT_SHA=07e9d558f2588889b328eb625efd7343412fbcb2`
- `PRODUCTION_COMMIT=07e9d558f2588889b328eb625efd7343412fbcb2`
- `VERCEL_PRODUCTION_STATUS=success`
- `AUTHENTICATED_SMOKE=PASS_WITH_LIMITATIONS`
- `REAL_DATA_INTEGRITY=PASS`
- `ROLLBACK_TRIGGERED=false`
- `FIREBASE_WRITE_STATUS=NOT_TESTED_BY_DESIGN`
- `SECURITY_WRITE_STATUS=NOT_TESTED_BY_DESIGN`
- `DESTRUCTIVE_FLOW_STATUS=NOT_TESTED_BY_DESIGN`
- `FIREBASE_WRITE_RESIDUAL_RISK=LOW_TO_MEDIUM; no regression evidence and no write was forced.`
- `SECURITY_WRITE_RESIDUAL_RISK=LOW_TO_MEDIUM; read-only production/auth smoke passed, mutation was intentionally omitted.`
- `DESTRUCTIVE_FLOW_RESIDUAL_RISK=LOW; destructive handlers were not exercised by design and no safety regression was observed.`
- `RF_DOC_CONSISTENCY=PASS`
- `ORIGIN_MAIN=07e9d558f2588889b328eb625efd7343412fbcb2`
- `EXPECTED_PRODUCTION_COMMIT=07e9d558f2588889b328eb625efd7343412fbcb2`
- `MAIN_MATCHES_PRODUCTION=true`
- `CANONICAL_BRANCH=feat/visual-product-north-star`
- `CANONICAL_HEAD=8b0d8bb7be4aac9e6454fb10acc82101ea3fd734`
- `CANONICAL_STATUS=pre-existing dirty historical/reference changes preserved`
- `INTEGRATION_BRANCH=release/visual-product-integration`
- `INTEGRATION_HEAD=14a21de8d156f4e08e428c2449c307976a1d49d9`
- `WORKTREE_CLEAN=false; release report has intentional uncommitted closure evidence.`
- `UNIQUE_COMMITS_IN_INTEGRATION=39; squash merge incorporated content but not individual commit ancestry.`
- `UNTRACKED_FILES=0`
- `MODIFIED_FILES=1; docs/ai/RELEASE_INTEGRATION_REPORT.md`
- `STAGED_FILES=0`
- `INTEGRATION_MERGED_INTO_MAIN=true; PR #352 merged.`
- `REMOTE_INTEGRATION_BRANCH_EXISTS=true`
- `SAFE_TO_REMOVE_WORKTREE=false`
- `WORKTREE_REMOVAL_STATUS=DEFERRED_FOR_SAFETY`
- `OLD_INTEGRATION_PATH_PRESERVED=true`
- `CANONICAL_HEAD_UNCHANGED=true`
- `CANONICAL_STATUS_PRESERVED=true`
- `CANONICAL_BRANCH_UNCHANGED=true`
- `BRANCH_CLEANUP_DEFERRED=true`
- `RELEASE_CLOSURE=COMPLETE_WITH_WORKTREE_PRESERVED`
- `NEXT_RECOMMENDED_ACTION=preservar o worktree de integração e tratar a limpeza/branch em missão separada, após decisão explícita sobre o histórico squash.`
