...
- V272 classifier, V271 readiness gate, existing V248 engine hardening (including fail-closed ambiguous-flow candidates), and read-only legacy History/Reports disclosure are implemented. Local tests/build/QA passed: focused 93/93, modern 815/815, general 249/249, QA harness 2/2, all builds and `qa:all`; rendered section verified in synthetic test mode across seven widths, panel-scoped axe 0, screenshots visually inspected.
